  ...
  */
    ...
    class BrowserRenderer {
        ...
        applyAttribute(batch, componentId, toDomElement, attributeFrame) {
            ...
            const eventHandlerId =
                frameReader.attributeEventHandlerId(attributeFrame);
            if (eventHandlerId) {
        ...
        switch (element.getAttribute("type")) {
            case "time":
                return value.length === 8 &&
                    (value.endsWith("00") || !element.hasAttribute("step"))
                    ? value.substring(0, 5)
                    : value;
            case "datetime-local":
    ...
    function inAuthRedirectIframe() {
        ...
        if (window.parent !== window && !window.opener && window.frameElement) {
            ...
            return (
                ...
                location.href.startsWith(settings.redirect_uri)
            );
        }
        return false;
    }
